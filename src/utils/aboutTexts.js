export const moreEnglish = [
  ...
  "💛 My dream is to be a Technical Product Manager and apply my skills, empathy and ideas together with a powerful team to create together products that optimize people's lives.",
...
export const moreSpanish = [
  ...
  "💛 Mi sueño es ser Technical Product Manager y aplicar mis habilidades, empatía e ideas junto a un poderoso equipo para crear juntos productos que optimicen la vida de las personas.",
